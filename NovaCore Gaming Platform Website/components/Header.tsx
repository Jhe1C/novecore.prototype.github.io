        ...
        {uniqueResults.slice(0, 6).map((game, index) => (
          ...
          >
            ...
            <div className="flex-1 min-w-0">
              <h4 className="font-medium text-[var(--text-primary)] line-clamp-1 mb-1">
...
export function Header({
  ...
  return (
    <header className="header-main">
      <div className="container mx-auto px-4 sm:px-6 content-width">
        <nav className="nav-main">
          <div className="grid grid-cols-12 items-center h-16 gap-4">
            {/* Left: Logo - Always visible with enhanced sizing */}
            <div className="col-span-4 sm:col-span-3 lg:col-span-2">
              ...
              >
                <div className="h-[60px] w-[198px] flex items-center justify-center">
                  <Frame1 />
                </div>
              </button>
            </div>

            {/* Center: Main Navigation + Search - Key functionality */}
            <div className="col-span-4 sm:col-span-6 lg:col-span-8 flex items-center justify-center space-x-6">
              {/* Desktop Navigation */}
                    ...
                    {item.submenu ? (
                      <div className="relative">
                        <button
                          ...
                          className={`dropdown-item flex items-center space-x-2 px-4 py-2 rounded-lg transition-all duration-200 hover:bg-[var(--slate-medium)] ${
              ...
              {/* Search Bar - Key functionality in center */}
            ...
            {/* Right: User Actions - Wishlist, Cart, User, Mobile Menu */}
            <div className="col-span-4 sm:col-span-3 lg:col-span-2 flex items-center justify-end space-x-2">
              ...
              <div className="relative">
                <Button
                  ...
                  className={`hidden sm:flex vanguard-btn-ghost ${isActivePage('wishlist') ? 'text-[var(--accent-blue)]' : ''}`}
                >
                  <Heart className="w-5 h-5" />
                </Button>
                {wishlistCount > 0 && (
                  <Badge className="absolute -top-1 -right-1 h-5 w-5 text-xs bg-[var(--accent-orange)] hover:bg-[var(--accent-orange)] p-0 flex items-center justify-center">
              ...
              <div className="relative" ref={cartRef}>
                ...
                >
                  ...
                  {cartItemCount > 0 && (
                    <Badge className="absolute -top-1 -right-1 h-5 w-5 text-xs bg-[var(--accent-blue)] hover:bg-[var(--accent-blue)] p-0 flex items-center justify-center">
              ...
              <div className="hidden sm:block nav-dropdown-container">
                <button
                  onClick={() => handleDropdownToggle('user')}
                  className="dropdown-item flex items-center space-x-2 px-3 py-2 rounded-lg transition-all duration-200 hover:bg-[var(--slate-medium)]"
                >
              ...
              <Button
                ...
                className="sm:hidden vanguard-btn-ghost"
              >
            ...
            <div className="mobile-menu sm:hidden">
              <div className="px-4 py-4 space-y-6">
                ...
                <div className="border-t border-[var(--border-subtle)] pt-4 space-y-2">
                  {/* Wishlist - Mobile with count */}
                  <button
                    onClick={() => handleNavigateAndClose('wishlist')}
                    className={`w-full dropdown-item flex items-center justify-between px-4 py-3 rounded-lg transition-all duration-200 hover:bg-[var(--slate-medium)] ${
                      isActivePage('wishlist') ? 'dropdown-item-active' : ''
                    }`}
                  >
                    <div className="flex items-center">
                      <Heart className="w-5 h-5 mr-3" />
                      <span className="font-medium">我的願望清單</span>
                    </div>
                    {wishlistCount > 0 && (
                  ...
                  {USER_MENU_ITEMS.slice(0, 3).map((item) => (
                    <button
                      key={item.id}
                      onClick={() => handleNavigateAndClose(item.page)}
                      className={`w-full dropdown-item px-4 py-3 rounded-lg transition-all duration-200 hover:bg-[var(--slate-medium)] ${
